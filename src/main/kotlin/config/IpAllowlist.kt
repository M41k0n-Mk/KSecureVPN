...
object IpAllowlist {
    ...
    private fun String.parseInetAddress(): InetAddress? = runCatching { InetAddress.getByName(this) }.getOrNull()

    private fun InetAddress.matchesEntry(entry: String): Boolean = if ('/' in entry) matchesCidr(entry) else matchesSingleIp(entry)
    ...
    private fun Inet4Address.matchesIpv4Cidr(
    ...
    private fun Inet6Address.matchesIpv6Cidr(
