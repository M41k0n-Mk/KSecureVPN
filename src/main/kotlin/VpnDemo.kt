...
fun main() =
    runBlocking {
        ...
        println("│ ALICE:")
        println(
            "│    ├─ Pacotes enviados: ${aliceTun.sentCount.get()}",
        )
        println(
            "│    ├─ Pacotes recebidos: ${aliceTun.receivedCount.get()}",
        )
        println(
            "│    └─ Bytes trafegados: ${aliceTun.totalBytes.get()} bytes",
        )
        println("│")
        println("│ BOB:")
        println(
            "│    ├─ Pacotes enviados: ${bobTun.sentCount.get()}",
        )
        println(
            "│    ├─ Pacotes recebidos: ${bobTun.receivedCount.get()}",
        )
        println(
            "│    └─ Bytes trafegados: ${bobTun.totalBytes.get()} bytes",
        )
        println("│")
