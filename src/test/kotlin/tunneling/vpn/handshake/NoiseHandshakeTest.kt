...
class NoiseHandshakeTest {
    ...
    fun testInvalidServerPublicKey() {
        ...
        val (clientInitBytes, clientState) = NoiseHandshake.clientInit()
        val (serverRespBytes, _) = NoiseHandshake.serverRespond(
            clientInitBytes!!,
        ...
        val (_, clientKeys) = NoiseHandshake.clientFinalize(
            serverRespBytes!!,
            clientState!!,
    ...
    fun testInvalidInitMessage() {
        ...
        val (respBytes, respState) = NoiseHandshake.serverRespond(
            invalidInit,
